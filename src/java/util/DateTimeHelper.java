...
public class DateTimeHelper {
    ...
    public static int isHistory(LocalDate date) {
    ...
    public static String getDateTimeStringNow() {
        ...
        return toDateTimeSql(now);
    }

    public static String toDateTimeSql(LocalDateTime datetime) {
        try {
            DateTimeFormatter formatter = DateTimeFormatter.ofPattern("yyyy-MM-dd'T'HH:mm:ss.nnn", Locale.US);
            LocalDateTime createdTime = LocalDateTime.parse(datetime.toString(), formatter);
    ...
    public static java.sql.Date getDateRemoveTime(LocalDateTime localDateTime) throws ParseException {
        Timestamp ts = Timestamp.valueOf(localDateTime);
        SimpleDateFormat dateFormat = new SimpleDateFormat("yyyy-MM-dd");
        String dateString = dateFormat.format(ts);
        java.sql.Date date = java.sql.Date.valueOf(dateString);
        return date;
    }
//    public static void main(String[] args) {
//        String timeString = "2023-02-19 10:46:10";
//        LocalDateTime time = toLocalDateTime(timeString);
