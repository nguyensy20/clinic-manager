                    ...
                    <div class="layout-page">
                        ...
                        <div class="card" style="margin-top: 15px; margin-left: 15px; overflow-x: auto;">
                            ...
                            <div class="card-body">
                                        ...
                                        <tbody>
                                            ...
                                            <c:forEach items="${requestScope.services}" var="s" varStatus="loop">
                                                <tr>
                                                    ...
                                                    <td>${s.name}</td>  
                                                    <td style="white-space: pre-wrap;">${s.description}</td> 
                                                    <td>
                                                        <div  >
                                                            <a style="color: gray;display: inline-block;" href="/SWP391_Project/manage/services?action=edit&id=${s.id}">
                                                                <i class="bx bx-edit-alt me-1"></i> Edit
                                                            </a>
                                                            <form style="display: inline-block;" action="/SWP391_Project/manage/services" method="POST" onsubmit="return confirm('Bạn có chắc chắn muốn xóa?')">
                                ...
                                <a href="/SWP391_Project/manage/services?action=create"><button type="button" class="btn btn-outline-secondary">Thêm dịch vụ </button></a>
                            </div>
                        </div>
