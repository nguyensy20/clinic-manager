                ...
                <div class="layout-container">
                    ...
                    <div class="layout-page">
                        ...
                        <div class="content-wrapper" style="margin-top: 15px; margin-left: 15px"> 
                            ...
                            <c:if test="${requestScope.treatment.id ne null }">
                                <div class="card mb-4">
                                    <h5 class="card-header">Chỉnh sửa  </h5>
                                    <form action="/SWP391_Project/manage/treatment" method="post" onsubmit="return confirm('Bạn có muốn chỉnh sửa không?')">
                                        <input type="hidden" name="action" value="edit">
                                        <input type="hidden" name="id" value="<%= request.getParameter("id") %>">
                                        <div class="card-body">
                                            <div class="mb-3">
                                                <label for="exampleFormControlInput1" class="form-label">Tên phương pháp điều trị</label>
                                                <input value="${requestScope.treatment.name}" 
                                                       name="name" type="text" 
                                                       class="form-control" 
                                                       id="exampleFormControlInput1" 
                                                       placeholder="Streatment name" 
                                                       required minlength="10" maxlength="500"/>
                                                <div class="invalid-feedback">
                                                    Tên không hợp lệ (10-500 ký tự).
                                                </div>
                                            </div>
                                            <div>
                                                ...
                                                <input name="price" type="number" 
                                                       ...
                                                       placeholder="Price" 
                                                       value="${requestScope.treatment.price}" required min="0" step="any"/>
                                                <div class="invalid-feedback">
                                       ...
                                       <c:if test="${requestScope.treatment.id eq null}">
                                <div class="card mb-4">
                                    <h5 class="card-header">Thêm phương pháp điều trị </h5>
                                    <form action="/SWP391_Project/manage/treatment" method="post" onsubmit="return confirm('Bạn muốn thêm dịch vụ này không?')">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <button type="submit" class="btn btn-outline-success">Thêm phương pháp </button>
                                        </div>
                                    </form>
                                </div>
                            </c:if>
