<%-- 
    Document   : login
    Created on : Feb 26, 2023, 10:39:33 AM
    Author     : nguye
--%>
...
<html>
    ...
    <head>
        ...
        <!-- Page CSS -->
        <!-- Page -->
        <link rel="stylesheet" href="dashboard_style/assets/vendor/css/pages/page-auth.css" />
        <!-- Helpers -->
                ...
                <div class="authentication-inner">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <h4 class="mb-2">Welcome to G3 ENT Clinic 👋</h4>
                            ...
                            <form id="formAuthentication" class="mb-3" action="register" method="POST">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" name ="phone" placeholder="Enter your phone" autofocus/> 
                                </div>
                                <div class="mb-3">
                                    <label for="address" class="form-label">Address: </label>
                                    <input type="text" class="form-control" name="address" placeholder="Enter your address" autofocus/> 
                                </div>
                                <div class="mb-3">
                                ...
                                <div class="mb-3 form-password-toggle">
                                    ...
                                    <div class="input-group input-group-merge">
                                        <input type="password" id="password" class="form-control" name="passwordHash"
                                               placeholder="&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;"
