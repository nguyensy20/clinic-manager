                    ...
                    <div class="layout-page">
                        ...
                        <div class="content-wrapper">
                            ...
                            <div class="container-xxl flex-grow-1 container-p-y">
                                <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light"></span>Bill list</h4>
                                <div class="card">
                                        ...
                                        <div class="table-responsive text-nowrap">
                                            <table class="table table-bordered">
                                                ...
                                                <tbody>
                                                    ...
                                                    <c:forEach items="${requestScope.medicalReports}" var="md">
                                                        <tr>
                                                            <td>${user.getNameById(md.patient_id)}</td>
                                                            <td>${user.getNameById(md.doctor_id)}</td>
                                                            <td>${helper.toDateTimeSql(md.time)}</td>
                                                            <td><a href="create-bill?patient_id=${md.patient_id}&doctor_id=${md.doctor_id}&time=${helper.toDateTimeSql(md.time)}">link bill</a></td>
                                                        </tr>
