                    ...
                    <div class="layout-page">
                        ...
                        <div class="content-wrapper">
                            ...
                            <div class="container-xxl flex-grow-1 container-p-y">
                                <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light"></span>Booked list</h4>
                                <div class="card">
                                    <div class="card-body">
                                                ...
                                                <tbody>
                                                    ...
                                                    <c:forEach items="${requestScope.bookings}" var="b">
                                                        <tr>
                                                            ...
                                                            <td>${helper.toDateTimeSql(b.created_time)}</td>
                                                            <td>${b.reason}</td>
                                                            <td><a href="booked-list?action=move&patient_id=${b.patient.id}&book_created_time=${helper.toDateTimeSql(b.created_time)}&booking_time=${b.booking_time}&reason=${b.reason}">Move to Waiting list</a></td>
                                                        </tr>
