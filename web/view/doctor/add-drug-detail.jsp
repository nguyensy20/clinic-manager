                    ...
                    <div class="layout-page">
                        ...
                        <div class="content-wrapper">
                            ...
                            <div class="container-xxl flex-grow-1 container-p-y">
                                <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Forms /</span>Add drug detail</h4>
                                <div class="row">
                                    <!-- Basic -->
                                    <div class="col-md-10">
                                        ...
                                        <div class="card mb-4">
                                            ...
                                            <div class="card-body">
                                                <form action="add-drug-detail" method="post">
                                                    <!-- Number -->
                                                    <div class="mb-3">
                                                        <label for="defaultSelect" class="form-label">Select treatment</label>
                                                        <select id="defaultSelect" class="form-select" name="drug">
                                                            <c:set var="rpD" value="${requestScope.reportDrug}"></c:set>
                                                    ...
                                                    <label for="html5-number-input" class="form-label">Amount</label>
                                                    <input type="hidden" name="action" value="${requestScope.action}">
                                                    <input class="form-control" name="amount" type="number" value="${rpD.amount}"
                                                           id="html5-number-input">
                                                    <label for="exampleFormControlTextarea1" class="form-label">Dosage</label>
                                                    <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" name="dosage">${rpD.dosage}</textarea>
                                                    <div class="row justify-content-end">
                                                        <div class="col-sm-10">
                                                            <button type="submit" class="btn btn-primary" name="submit" value="back">Back</button>
